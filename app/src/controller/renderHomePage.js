...
function renderHomePage(req, res, next,props) {
        var syncTemplates = PartnerContentTemplateModel.getSyncPageTemplate(req,"home",props.theme);
        var asyncTemplates = PartnerContentTemplateModel.getAsyncPageTemplate(req,"home",props.theme);
        var aTemplates = [];
