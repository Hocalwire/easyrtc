...
Mobify.UI.Utils = (function($) {
    ...
    */
    ...
    if (has.transform3d) {
        exports.translateX = function(element, delta,noSlide) {
             ...
             if(!noSlide) {
                ...
                //setTimeout(function(){element.style['opacity']=1;},400);
                //element.style.left = delta;
            }
        };
...
Mobify.UI.Carousel = (function($, Utils) {
    ...
    Carousel.prototype.update = function(noSlide) {
        ...
        Utils.requestAnimationFrame(function() {
            self._update(noSlide);
        });
    }

    Carousel.prototype._update = function(noSlide) {
        if (!this._needsUpdate) {
            return;
        }
        ...
        Utils.translateX(this.$inner[0], x,noSlide);
    ...
    Carousel.prototype.bind = function() {
        ...
        $element.on('afterSlide', function(e, previousSlide, nextSlide,isMove) {
    ...
    Carousel.prototype.move = function(newIndex, opts) {
        ...
        opts = opts || {};
        var noSlide;
        if (opts && opts.noSlide) {
            noSlide = opts.noSlide;
        ...
        this.update(opts.noSlide);
        // Trigger afterSlide event
        $element.trigger('afterSlide', [index, newIndex,noSlide]);
    };
...
(function($) {
    ...
    */
    $.fn.carousel = function (action, options) {
        ...
        var noSlide;
        if (action=="move" && options && options.noSlide) {
            noSlide = options.noSlide;
        ...
        this.each(function () {
            ...
            if (action) {
                carousel[action](options,{'noSlide':noSlide});
