...
var url = "/xhr/admin/getPartnerNotificationData?partner=$$$PARTNER_NAME$$$";
self.addEventListener('push', function (event) {
    event.waitUntil(
            ...
            .then(function (clientList) {
                ...
                if (clients.openWindow) {
                    if (event.action === 'settings') {
                        return clients.openWindow('https://hocalwire.com/notification-settings?partner=$$$PARTNER_NAME$$$');                        
                    } else {
